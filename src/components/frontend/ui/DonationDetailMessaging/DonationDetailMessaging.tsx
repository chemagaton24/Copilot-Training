...
export const DonationDetailMessaging: React.FC<
  DonationDetailMessagingProps
> = ({ className }) => {
  return (
    <section
      className={cn(
    ...
    >
      <header className="flex w-full flex-col gap-6">
        ...
        >
          Donations to RealClear Media Fund are tax-deductible (EIN:
          20-1382746).
        </Text>
      </header>
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-5 text-text-base-primary">
          <Text as="p" breakpoints={{ default: "body-md-regular" }}>
            RealClearPolitics, along with more than a dozen sister sites,
            provides a rich and unique collection of thought encompassing an
            impressive variety of disciplines. And the RealClearPolitics Polling
            Average is widely recognized as the nation&apos;s leading authority
            in election polling.
          </Text>
          <Text as="p" breakpoints={{ default: "body-md-regular" }}>
            The articles curated on RealClear pages are the product of
            thoughtful, time-sensitive human judgment, not algorithms. Every
            morning, RealClear editors rise early and survey the Internet for
            the must-read news, analysis, commentary, and investigative
            journalism of the day—across a wide span of perspectives.
          </Text>
          <Text as="p" breakpoints={{ default: "body-md-regular" }}>
            RealClear&apos;s professional reporters cover the nation&apos;s most
            important stories from the White House and across the nation, and
            their work is edited to the highest of standards.
          </Text>
          <Text as="p" breakpoints={{ default: "body-md-regular" }}>
            Your tax-deductible charitable gift to RealClear Media Fund (EIN:
            20-1382746) supports all these efforts and helps promote an informed
            public discourse and debate. You are investing in the maintenance of
            democracy.
          </Text>
          <Text as="p" breakpoints={{ default: "body-md-regular" }}>
            Making a contribution today couldn&apos;t be easier. To give by
            credit card, complete the form below. If you&apos;d prefer to give
