...
const defaultDonationDriveMock: DonationDriveProps = {
  ...
  description: (
    <p>
      The Internet provides an endless stream of content. Not all of it is worth
      your time. That&apos;s why, every day, we curate the most essential news
      and information—from all sides and across mediums.
    </p>
  ),
  tagline: "Demo Trusted by policymakers",
